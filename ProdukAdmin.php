            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        ...
                        <a href="contentAdmin.php"><p style="color:#0A49F3">Produk</p> </a>
                    </li>

                    <li>

                        <a href="kebutuhanAdmin.php#kebutuhan"><p >Kebutuhan</p> </a>
                    </li>
                    <li>
...
<head>
    ...
    <!-- Page Content -->
    <div class="navigasi">
      <p><a href="indexAdmin.php">Beranda</a> > <a href="contentAdmin.php">Pasar</a> > Produk</p>
</div>
	<a  name="services"></a>
...
if($row > 0){ // Jika jumlah data lebih dari 0 (Berarti jika data ada)
	while($data = mysqli_fetch_array($sql)){ // Ambil semua data dari hasil eksekusi $sql
		echo "<tr>";
		echo "<td bgcolor='#FFFFFF'><p align='center'><img src='img/".$data['nama']."' width='250' height='150'></p></td>";
		echo "<td bgcolor='#FFFFFF'> <p align='center'> ".$data['namaProduk']."</p></td>";
		echo "<td bgcolor='#FFFFFF'> <p align='center'>".$data['ukuran']."</p></td>";
		echo "<td bgcolor='#FFFFFF'> <p align='center'>".$data['tipe']."</p></td>";
		echo "</tr>";
	}
