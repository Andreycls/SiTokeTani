...
<head>
    ...
    <!-- Page Content -->
<p><a href="contentAdmin.php">Pasar</a> > <a href="produkAdmin.php">Produk</a> > form Produk</p>
	<a  name="services"></a>
  ...
  <table align="center" border="0" width="800">
    ...
    <tr>
      <td><h3>Jenis Produk</h3></td>
      <td> <input width="200"type="text" name="jenisProduk" placeholder="Contoh : Buah - Buahan"></input></td>
    </tr>
    <tr>
      <td><h3>Penjual</h3></td>
      <td><input width="200" type="text" name="penjual" placeholder="Contoh : UD.Balige Jaya"></td>
    </tr>
    <tr>
